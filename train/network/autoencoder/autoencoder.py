...
from components.harmonic_oscillator import PolyHarmonicOscillator
...
class AutoEncoder(nn.Module):
    def __init__(self, config):
        ...
        self.harmonic_oscillator = PolyHarmonicOscillator(
        ...
        self.num_frames = int(config.waveform_sec * config.frame_resolution)
    ...
    def forward(self, batch, add_reverb=True):
        ...
        """
        #batch['f0'] = batch['f0'].reshape(self.batch_size, self.max_voices, self.num_frames)
        #batch['velocity'] = batch['velocity'].reshape(self.batch_size, self.max_voices, self.num_frames)
